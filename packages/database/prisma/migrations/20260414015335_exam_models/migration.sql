...
CREATE TABLE [dbo].[AcademicCohort] (
    ...
    [isActive] BIT NOT NULL CONSTRAINT [AcademicCohort_isActive_df] DEFAULT 1,
    [createdAt] DATETIME2 NOT NULL CONSTRAINT [AcademicCohort_createdAt_df] DEFAULT CURRENT_TIMESTAMP,
    [updatedAt] DATETIME2 NOT NULL CONSTRAINT [AcademicCohort_updatedAt_df] DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT [AcademicCohort_pkey] PRIMARY KEY CLUSTERED ([code])
);
...
CREATE TABLE [dbo].[Curriculum] (
    ...
    [cohort] VARCHAR(50) NOT NULL CONSTRAINT [Curriculum_cohort_df] DEFAULT 'K18',
    [suggestedSemester] INT NOT NULL CONSTRAINT [Curriculum_suggestedSemester_df] DEFAULT 1,
    [isRequired] BIT CONSTRAINT [DF__Curriculu__isReq__3CF40B7E] DEFAULT 1,
    CONSTRAINT [PK__Curricul__3213E83F6570CBC5] PRIMARY KEY CLUSTERED ([id]),
...
CREATE TABLE [dbo].[Subject] (
    ...
    [examDuration] INT NOT NULL CONSTRAINT [Subject_examDuration_df] DEFAULT 90,
    [examType] VARCHAR(50) NOT NULL CONSTRAINT [Subject_examType_df] DEFAULT 'TRAC_NGHIEM',
    [examForm] VARCHAR(50) NOT NULL CONSTRAINT [Subject_examForm_df] DEFAULT 'T? lu?n',
    [theoryPeriods] INT CONSTRAINT [DF__Subject__theoryP__5E8A0973] DEFAULT 0,
    [practicePeriods] INT CONSTRAINT [DF__Subject__practic__5F7E2DAC] DEFAULT 0,
    [practiceSessionsPerWeek] INT NOT NULL CONSTRAINT [Subject_practiceSessionsPerWeek_df] DEFAULT 1,
    [theorySessionsPerWeek] INT NOT NULL CONSTRAINT [Subject_theorySessionsPerWeek_df] DEFAULT 1,
...
CREATE TABLE [dbo].[Student] (
    ...
    [academicStatus] VARCHAR(50) NOT NULL CONSTRAINT [Student_academicStatus_df] DEFAULT 'NORMAL',
...
CREATE TABLE [dbo].[Semester] (
    ...
    [midtermGradeDeadline] DATETIME2,
    [examEndDate] DATE,
    [examStartDate] DATE,
    [semesterNumber] INT NOT NULL CONSTRAINT [Semester_semesterNumber_df] DEFAULT 1,
...
CREATE TABLE [dbo].[CourseClass] (
    ...
    [totalPeriods] INT NOT NULL CONSTRAINT [CourseClass_totalPeriods_df] DEFAULT 45,
    [sessionsPerWeek] INT CONSTRAINT [CourseClass_sessionsPerWeek_df] DEFAULT 1,
    [periodsPerSession] INT CONSTRAINT [CourseClass_periodsPerSession_df] DEFAULT 3,
...
CREATE TABLE [dbo].[TrainingPlanTemplate] (
    ...
    [status] VARCHAR(50) NOT NULL CONSTRAINT [TrainingPlanTemplate_status_df] DEFAULT 'DRAFT',
    [publishedAt] DATETIME2,
    [copiedFromTemplateId] VARCHAR(50),
    [createdAt] DATETIME2 NOT NULL CONSTRAINT [TrainingPlanTemplate_createdAt_df] DEFAULT CURRENT_TIMESTAMP,
    [updatedAt] DATETIME2 NOT NULL CONSTRAINT [TrainingPlanTemplate_updatedAt_df] DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT [TrainingPlanTemplate_pkey] PRIMARY KEY CLUSTERED ([id]),
    CONSTRAINT [TrainingPlanTemplate_majorId_cohort_version_key] UNIQUE NONCLUSTERED ([majorId],[cohort],[version])
);
...
CREATE TABLE [dbo].[TrainingPlanTemplateItem] (
    ...
    [isRequired] BIT NOT NULL CONSTRAINT [TrainingPlanTemplateItem_isRequired_df] DEFAULT 1,
    [theoryPeriods] INT,
    [practicePeriods] INT,
    [theorySessionsPerWeek] INT,
    [practiceSessionsPerWeek] INT,
    [periodsPerSession] INT,
    [createdAt] DATETIME2 NOT NULL CONSTRAINT [TrainingPlanTemplateItem_createdAt_df] DEFAULT CURRENT_TIMESTAMP,
    [updatedAt] DATETIME2 NOT NULL CONSTRAINT [TrainingPlanTemplateItem_updatedAt_df] DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT [TrainingPlanTemplateItem_pkey] PRIMARY KEY CLUSTERED ([id]),
    CONSTRAINT [TrainingPlanTemplateItem_templateId_subjectId_key] UNIQUE NONCLUSTERED ([templateId],[subjectId])
);
...
CREATE TABLE [dbo].[SemesterPlan] (
    ...
    [conceptualSemester] INT NOT NULL,
    [status] VARCHAR(50) NOT NULL CONSTRAINT [SemesterPlan_status_df] DEFAULT 'DRAFT',
    [executedAt] DATETIME2,
    [createdAt] DATETIME2 NOT NULL CONSTRAINT [SemesterPlan_createdAt_df] DEFAULT CURRENT_TIMESTAMP,
    [updatedAt] DATETIME2 NOT NULL CONSTRAINT [SemesterPlan_updatedAt_df] DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT [SemesterPlan_pkey] PRIMARY KEY CLUSTERED ([id]),
    CONSTRAINT [SemesterPlan_semesterId_majorId_cohort_key] UNIQUE NONCLUSTERED ([semesterId],[majorId],[cohort])
);
...
CREATE TABLE [dbo].[SemesterPlanItem] (
    ...
    [lecturerId] VARCHAR(50),
    [status] VARCHAR(50) NOT NULL CONSTRAINT [SemesterPlanItem_status_df] DEFAULT 'DRAFT',
    [expectedStudentCount] INT NOT NULL CONSTRAINT [SemesterPlanItem_expectedStudentCount_df] DEFAULT 0,
    [generatedCourseClassId] VARCHAR(50),
    [theoryPeriods] INT,
    [practicePeriods] INT,
    [theorySessionsPerWeek] INT,
    [practiceSessionsPerWeek] INT,
    [periodsPerSession] INT,
    [createdAt] DATETIME2 NOT NULL CONSTRAINT [SemesterPlanItem_createdAt_df] DEFAULT CURRENT_TIMESTAMP,
    [updatedAt] DATETIME2 NOT NULL CONSTRAINT [SemesterPlanItem_updatedAt_df] DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT [SemesterPlanItem_pkey] PRIMARY KEY CLUSTERED ([id]),
    CONSTRAINT [SemesterPlanItem_semesterPlanId_subjectId_adminClassId_key] UNIQUE NONCLUSTERED ([semesterPlanId],[subjectId],[adminClassId])
);
...
CREATE TABLE [dbo].[ClassSchedule] (
    ...
    [roomId] VARCHAR(50),
    [type] NVARCHAR(50) CONSTRAINT [DF__ClassSched__type__477199F1] DEFAULT 'N''STUDY''',
    CONSTRAINT [PK__ClassSch__3213E83FABA7CEB6] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[ClassSession] (
    ...
    [type] VARCHAR(50) NOT NULL CONSTRAINT [ClassSession_type_df] DEFAULT 'LECTURE',
    [note] NVARCHAR(255),
    CONSTRAINT [ClassSession_pkey] PRIMARY KEY CLUSTERED ([id]),
    CONSTRAINT [ClassSession_roomId_date_startShift_semesterId_key] UNIQUE NONCLUSTERED ([roomId],[date],[startShift],[semesterId])
);
...
CREATE TABLE [dbo].[Grade] (
    ...
    [regularScores] NVARCHAR(max),
    [coef1Scores] NVARCHAR(max),
    [coef2Scores] NVARCHAR(max),
    [practiceScores] NVARCHAR(max),
    [tbThuongKy] FLOAT(53),
    ...
    [examScore1] FLOAT(53),
    [examScore2] FLOAT(53),
    [finalScore1] FLOAT(53),
    [finalScore2] FLOAT(53),
    ...
    [status] VARCHAR(50) NOT NULL CONSTRAINT [Grade_status_df] DEFAULT 'DRAFT',
...
-- CreateTable
CREATE TABLE [dbo].[SubjectPrerequisite] (
    [id] VARCHAR(50) NOT NULL,
    [subjectId] VARCHAR(50) NOT NULL,
    [prerequisiteSubjectId] VARCHAR(50) NOT NULL,
    CONSTRAINT [PK__SubjectP__3213E83FE822B36A] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[TeachingPlan] (
    ...
    [semesterId] VARCHAR(50) NOT NULL,
    [lecturerId] VARCHAR(50),
    [status] NVARCHAR(50) CONSTRAINT [DF__TeachingP__statu__41B8C09B] DEFAULT 'N''DRAFT''',
    [totalPeriods] INT CONSTRAINT [DF__TeachingP__total__42ACE4D4] DEFAULT 0,
    CONSTRAINT [PK__Teaching__3213E83FE850BEF5] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[ExamSchedule] (
    ...
    [startShift] INT NOT NULL,
    [endShift] INT NOT NULL,
    [type] VARCHAR(50) NOT NULL CONSTRAINT [ExamSchedule_type_df] DEFAULT 'FIRST_ATTEMPT',
    [status] VARCHAR(50) NOT NULL CONSTRAINT [ExamSchedule_status_df] DEFAULT 'PLANNED',
    [createdAt] DATETIME2 NOT NULL CONSTRAINT [ExamSchedule_createdAt_df] DEFAULT CURRENT_TIMESTAMP,
    [updatedAt] DATETIME2 NOT NULL CONSTRAINT [ExamSchedule_updatedAt_df] DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT [ExamSchedule_pkey] PRIMARY KEY CLUSTERED ([id])
);
...
CREATE TABLE [dbo].[ExamRoom] (
    ...
    [capacity] INT NOT NULL CONSTRAINT [ExamRoom_capacity_df] DEFAULT 40,
    [supervisor] NVARCHAR(100),
    CONSTRAINT [ExamRoom_pkey] PRIMARY KEY CLUSTERED ([id]),
    CONSTRAINT [ExamRoom_examScheduleId_roomId_key] UNIQUE NONCLUSTERED ([examScheduleId],[roomId])
);

-- CreateTable
CREATE TABLE [dbo].[ExamStudent] (
    [id] VARCHAR(50) NOT NULL,
    [examRoomId] VARCHAR(50) NOT NULL,
    [studentId] VARCHAR(50) NOT NULL,
    CONSTRAINT [ExamStudent_pkey] PRIMARY KEY CLUSTERED ([id]),
    CONSTRAINT [ExamStudent_examRoomId_studentId_key] UNIQUE NONCLUSTERED ([examRoomId],[studentId])
);
...
-- CreateIndex
CREATE NONCLUSTERED INDEX [TrainingPlanTemplate_majorId_cohort_status_idx] ON [dbo].[TrainingPlanTemplate]([majorId], [cohort], [status]);

-- CreateIndex
CREATE NONCLUSTERED INDEX [TrainingPlanTemplateItem_templateId_conceptualSemester_idx] ON [dbo].[TrainingPlanTemplateItem]([templateId], [conceptualSemester]);

-- CreateIndex
CREATE NONCLUSTERED INDEX [SemesterPlan_majorId_cohort_status_idx] ON [dbo].[SemesterPlan]([majorId], [cohort], [status]);

-- CreateIndex
CREATE NONCLUSTERED INDEX [SemesterPlanItem_generatedCourseClassId_idx] ON [dbo].[SemesterPlanItem]([generatedCourseClassId]);

-- CreateIndex
CREATE NONCLUSTERED INDEX [SemesterPlanItem_lecturerId_idx] ON [dbo].[SemesterPlanItem]([lecturerId]);

-- CreateIndex
CREATE NONCLUSTERED INDEX [SemesterPlanItem_status_idx] ON [dbo].[SemesterPlanItem]([status]);

-- CreateIndex
CREATE NONCLUSTERED INDEX [ExamSchedule_semesterId_subjectId_idx] ON [dbo].[ExamSchedule]([semesterId], [subjectId]);
...
-- AddForeignKey
ALTER TABLE [dbo].[Curriculum] ADD CONSTRAINT [FK_Curriculum_Major] FOREIGN KEY ([majorId]) REFERENCES [dbo].[Major]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[Curriculum] ADD CONSTRAINT [FK_Curriculum_Subject] FOREIGN KEY ([subjectId]) REFERENCES [dbo].[Subject]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE [dbo].[Lecturer] ADD CONSTRAINT [Lecturer_departmentId_fkey] FOREIGN KEY ([departmentId]) REFERENCES [dbo].[Department]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE [dbo].[TrainingPlanTemplate] ADD CONSTRAINT [TrainingPlanTemplate_cohort_fkey] FOREIGN KEY ([cohort]) REFERENCES [dbo].[AcademicCohort]([code]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[TrainingPlanTemplate] ADD CONSTRAINT [TrainingPlanTemplate_copiedFromTemplateId_fkey] FOREIGN KEY ([copiedFromTemplateId]) REFERENCES [dbo].[TrainingPlanTemplate]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[TrainingPlanTemplate] ADD CONSTRAINT [TrainingPlanTemplate_majorId_fkey] FOREIGN KEY ([majorId]) REFERENCES [dbo].[Major]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[TrainingPlanTemplateItem] ADD CONSTRAINT [TrainingPlanTemplateItem_subjectId_fkey] FOREIGN KEY ([subjectId]) REFERENCES [dbo].[Subject]([id]) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[TrainingPlanTemplateItem] ADD CONSTRAINT [TrainingPlanTemplateItem_templateId_fkey] FOREIGN KEY ([templateId]) REFERENCES [dbo].[TrainingPlanTemplate]([id]) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[SemesterPlan] ADD CONSTRAINT [SemesterPlan_cohort_fkey] FOREIGN KEY ([cohort]) REFERENCES [dbo].[AcademicCohort]([code]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[SemesterPlan] ADD CONSTRAINT [SemesterPlan_majorId_fkey] FOREIGN KEY ([majorId]) REFERENCES [dbo].[Major]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[SemesterPlan] ADD CONSTRAINT [SemesterPlan_semesterId_fkey] FOREIGN KEY ([semesterId]) REFERENCES [dbo].[Semester]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[SemesterPlan] ADD CONSTRAINT [SemesterPlan_templateId_fkey] FOREIGN KEY ([templateId]) REFERENCES [dbo].[TrainingPlanTemplate]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[SemesterPlanItem] ADD CONSTRAINT [SemesterPlanItem_adminClassId_fkey] FOREIGN KEY ([adminClassId]) REFERENCES [dbo].[AdminClass]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[SemesterPlanItem] ADD CONSTRAINT [SemesterPlanItem_generatedCourseClassId_fkey] FOREIGN KEY ([generatedCourseClassId]) REFERENCES [dbo].[CourseClass]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[SemesterPlanItem] ADD CONSTRAINT [SemesterPlanItem_lecturerId_fkey] FOREIGN KEY ([lecturerId]) REFERENCES [dbo].[Lecturer]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[SemesterPlanItem] ADD CONSTRAINT [SemesterPlanItem_semesterPlanId_fkey] FOREIGN KEY ([semesterPlanId]) REFERENCES [dbo].[SemesterPlan]([id]) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[SemesterPlanItem] ADD CONSTRAINT [SemesterPlanItem_subjectId_fkey] FOREIGN KEY ([subjectId]) REFERENCES [dbo].[Subject]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE [dbo].[ClassSchedule] ADD CONSTRAINT [FK_Schedule_TP] FOREIGN KEY ([planId]) REFERENCES [dbo].[TeachingPlan]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[ClassSession] ADD CONSTRAINT [ClassSession_courseClassId_fkey] FOREIGN KEY ([courseClassId]) REFERENCES [dbo].[CourseClass]([id]) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[ClassSession] ADD CONSTRAINT [ClassSession_roomId_fkey] FOREIGN KEY ([roomId]) REFERENCES [dbo].[Room]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[ClassSession] ADD CONSTRAINT [ClassSession_semesterId_fkey] FOREIGN KEY ([semesterId]) REFERENCES [dbo].[Semester]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE [dbo].[Attendance] ADD CONSTRAINT [Attendance_enrollmentId_fkey] FOREIGN KEY ([enrollmentId]) REFERENCES [dbo].[Enrollment]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[Attendance] ADD CONSTRAINT [Attendance_sessionId_fkey] FOREIGN KEY ([sessionId]) REFERENCES [dbo].[ClassSession]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE [dbo].[SubjectPrerequisite] ADD CONSTRAINT [FK_Prereq_Subject] FOREIGN KEY ([subjectId]) REFERENCES [dbo].[Subject]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[SubjectPrerequisite] ADD CONSTRAINT [FK_Prereq_Subject_Pre] FOREIGN KEY ([prerequisiteSubjectId]) REFERENCES [dbo].[Subject]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[TeachingPlan] ADD CONSTRAINT [FK_TP_CourseClass] FOREIGN KEY ([courseClassId]) REFERENCES [dbo].[CourseClass]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[TeachingPlan] ADD CONSTRAINT [FK_TP_Semester] FOREIGN KEY ([semesterId]) REFERENCES [dbo].[Semester]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[ExamSchedule] ADD CONSTRAINT [ExamSchedule_semesterId_fkey] FOREIGN KEY ([semesterId]) REFERENCES [dbo].[Semester]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[ExamSchedule] ADD CONSTRAINT [ExamSchedule_subjectId_fkey] FOREIGN KEY ([subjectId]) REFERENCES [dbo].[Subject]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[ExamRoom] ADD CONSTRAINT [ExamRoom_examScheduleId_fkey] FOREIGN KEY ([examScheduleId]) REFERENCES [dbo].[ExamSchedule]([id]) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[ExamRoom] ADD CONSTRAINT [ExamRoom_roomId_fkey] FOREIGN KEY ([roomId]) REFERENCES [dbo].[Room]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[ExamStudent] ADD CONSTRAINT [ExamStudent_examRoomId_fkey] FOREIGN KEY ([examRoomId]) REFERENCES [dbo].[ExamRoom]([id]) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[ExamStudent] ADD CONSTRAINT [ExamStudent_studentId_fkey] FOREIGN KEY ([studentId]) REFERENCES [dbo].[Student]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
