        ...
        <div className="min-h-screen p-4 sm:p-6 md:p-8 max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex items-center justify-between pl-1">
                <div className="flex items-center gap-2 text-xs sm:text-sm font-semibold text-slate-800">
                    ...
                    <span className="text-indigo-600">Chọn lớp điểm danh</span>
                </div>
            </div>
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center gap-4 text-slate-500 mb-6">
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span className="text-xs font-bold">{c.currentSlots} SV</span>
                                    </div>
                                    <div className="flex items-center gap-1.5">
                                        <Calendar size={14} className="text-slate-300" />
                                        <span className="text-xs font-bold">{c.schedules?.length || 0} Tiết/tuần</span>
                                    </div>
                                </div>
