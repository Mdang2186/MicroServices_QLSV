...
export default function CourseClassCreationWizard({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-8 text-slate-800">
               ...
               {isCreatingNewSubject ? (
                 ...
                 <div className="space-y-4 animate-in zoom-in-95 duration-300">
                    ...
                    <div className="relative group">
                       ...
                       <input className="w-full bg-slate-50 border-none rounded-[32px] pl-14 pr-6 py-5 text-[12px] font-black outline-none focus:ring-4 focus:ring-uneti-blue/5 focus:bg-white transition-all text-slate-800" placeholder="Nhập mã hoặc tên học phần mẫu..." />
                    </div>
            ...
            <div className="space-y-10 animate-in fade-in slide-in-from-right-5 duration-500">
               ...
               <div className="grid grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <input type="number" className="w-full bg-slate-50 border-none rounded-2xl px-6 py-5 text-[11px] font-black text-slate-800 outline-none focus:ring-4 focus:ring-uneti-blue/5 transition-all text-slate-800" value={classInfo.maxSlots} onChange={e => setClassInfo({...classInfo, maxSlots: parseInt(e.target.value)})} />
                  </div>
                  <div className="space-y-4">
                  ...
                  {schedules.map((s, idx) => (
                    <div key={idx} className="p-8 bg-slate-50 border border-slate-100 rounded-[40px] grid grid-cols-4 gap-6 relative group animate-in zoom-in-95 duration-300 transition-all hover:bg-white hover:shadow-xl hover:shadow-slate-100">
                       ...
                       <div className="col-span-2">
                          ...
                          <select className="w-full bg-white border border-slate-100 rounded-xl px-4 py-3 text-[11px] font-black outline-none focus:ring-2 focus:ring-uneti-blue/10 appearance-none text-slate-800" value={s.roomId} onChange={e => updateSchedule(idx, 'roomId', e.target.value)}>
