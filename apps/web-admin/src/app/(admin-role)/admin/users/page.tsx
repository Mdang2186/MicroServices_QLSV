        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    { label: "Quản trị viên", value: stats.admins, icon: ShieldCheck, color: "uneti", trend: "Quyền cao nhất" },
                    { label: "Giảng viên", value: stats.lecturers, icon: GraduationCap, color: "indigo", trend: "Hệ thống LMS" },
                    { label: "Sinh viên", value: stats.students, icon: UserCheck, color: "amber", trend: "Cổng sinh viên" },
                ].map((s, i) => (
                        ...
                        <tbody className="divide-y divide-slate-50">
                            {filteredUsers.length > 0 ? filteredUsers.map((u) => (u && (
                                <tr key={u.id} className="hover:bg-slate-50/80 transition-colors group">
                                    ...
                                    <td className="py-5 px-8">
                                        <span className={`px-2.5 py-1.5 rounded-xl text-[9px] font-black tracking-widest uppercase shadow-sm ${u.role === 'ADMIN' ? 'bg-uneti-blue text-white' :
